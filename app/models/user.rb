class User < ActiveRecord::Base
  ...
  :exclusion => %w(about settings home forums subforums users relationships posts wallposts topics contact help login logout sessions signup followers following)
